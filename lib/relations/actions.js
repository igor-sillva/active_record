		...
		if (data.is_valid()){
			...
			var exec = data.constructor.exec((query.sql || query), params, function _exec_query_callback(error, response){
				...
				if (error || data.errors.any){
					...
					exec.rollback();
					console.error('\033[1;%sm(%sms)\033[1;37m rollback transaction\33[0m', COLOR, process.timeEnd);
					...
					console.info('\033[1;%sm(%sms) \033[1;37m commit transaction\33[0m', COLOR, process.timeEnd);
				}
