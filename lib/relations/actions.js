...
function Action (){
	...
	*/
	this.create = function create(params, callback){
		...
		// DELETE `id` for rescue error ER_DUP_ENTRY;
		if( params[this.primary_key] ) 
			delete params[this.primary_key];
