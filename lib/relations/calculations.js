...
function Calculations (){
	...
	*	})
	*/
	this.count = function ( column_name, conditions, values, callback ){
		var options = {}, query = ''
	...
	*	})
	*/
	this.average = function ( column_name, conditions, values, callback ){
		var options = {}, query = '';
	...
	*	})
	*/
	this.minimum = function ( column_name, conditions, values, callback ){
		var options = {}, query = '';
			column_name = column_name || 'id';
			conditions = conditions || null;
			values = values || [];
	...
	*	})
	*/
	this.maximum = function ( column_name, conditions, values, callback ){
		var options = {}, query = '';
			column_name = column_name || 'id';
			conditions = conditions || null;
			values = values || [];
	...
	*	})
	*/
	this.sum = function ( column_name, conditions, values, callback ){
		var options = {}, query = '';
			column_name = column_name || 'id';
			conditions = conditions || null;
			values = values || [];
